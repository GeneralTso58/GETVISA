...
# TEST_REFRESH_INTERVAL_RANGE_START_SECOND = 220
# TEST_REFRESH_INTERVAL_RANGE_END_SECOND = 350

REFRESH_INTERVAL_RANGE_START_SECOND = 5
REFRESH_INTERVAL_RANGE_END_SECOND = 10
